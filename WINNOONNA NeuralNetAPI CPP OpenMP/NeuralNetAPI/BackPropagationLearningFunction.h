...
class BackPropagationLearningFunction :
	public LearningFunction
{
public:
	BackPropagationLearningFunction(void);
	virtual ~BackPropagationLearningFunction(void);
...
public:
    ...
    */
	...
	void update_weight(Neuron *neuron);
	void calculate_error_delta(Neuron *neuron,double target);
	void calculate_error_delta(Neuron *neuron);
	void calculate_weight_updates(Neuron *neuron);
	double derived_bipolar_sigmoidal_cached(Neuron *neuron);
};
