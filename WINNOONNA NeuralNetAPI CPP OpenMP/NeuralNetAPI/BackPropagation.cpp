...
BackPropagation::BackPropagation(int n_inputs,int n_hidden,int n_outputs)
{
 ...
 vector<Neuron*>::iterator input_neurons_iter; 
 vector<Neuron*>::iterator hidden_neurons_iter;
 vector<Neuron*>::iterator output_neurons_iter;
 ...
 {
    vector<Neuron*> hidden_neuron_list = hidden_layer->getNeuron_list();
 ...
 while(hidden_neurons_iter!=hidden_neuron_list.end())
 {
	vector<Neuron*> output_neuron_list = output_layer->getNeuron_list();
