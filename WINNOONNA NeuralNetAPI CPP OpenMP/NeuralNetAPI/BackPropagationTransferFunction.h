...
class BackPropagationTransferFunction : public TransferFunction
{
public:
	BackPropagationTransferFunction(void);
	virtual ~BackPropagationTransferFunction(void);

	
	virtual void calculate_output(Neuron *neuron);
};
