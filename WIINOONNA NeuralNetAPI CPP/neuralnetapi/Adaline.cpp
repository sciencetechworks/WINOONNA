...
Adaline::Adaline(void)
{
 training_transfer_function=new AdalineTrainingTransferFunction();
 transfer_function=new AdalineTransferFunction();
 learning_function=new AdalineLearningFunction();
 learning_function->setNet(this);
 training_algorithm=new AdalineTrainingAlgorithm(this);
 setLearning_factor(1);
}

Adaline::~Adaline(void)
{
	delete training_transfer_function;
...
Adaline::Adaline(int n_inputs,int n_outputs)
{
 training_transfer_function=new AdalineTrainingTransferFunction();
 transfer_function=new AdalineTransferFunction();
 learning_function=new AdalineLearningFunction();
...
void Adaline::setLearning_factor(double alpha)
{
	((AdalineLearningFunction*)learning_function)->setLearning_factor(alpha);
}
