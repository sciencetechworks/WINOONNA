...
AdalineTrainingTransferFunction::AdalineTrainingTransferFunction(void)
{
}
...
void AdalineTrainingTransferFunction::calculate_output(Neuron *neuron)
{
	//En adaline la funcion de transferencia de entrenamiento
	//es la identidad, es decir, la neurona hace eco en la salida
	//de la suma pesada de aquello que escuchó a su entrada.
		double y_input=0.0;
	...
	neuron->setFired_output(neuron->getReceived_input());
}/**
 Wonderfully Integrated Native Object Oriented Neural Network API.
